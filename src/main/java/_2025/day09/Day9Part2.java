...
public class Day9Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day09/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day09/input_test.txt")))
	    {
