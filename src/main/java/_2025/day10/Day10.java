...
public class Day10
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day10/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day10/input_test.txt")))
		{
