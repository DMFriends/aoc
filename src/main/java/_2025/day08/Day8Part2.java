...
public class Day8Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day08/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day08/input_test.txt")))
		{
