...
public class Day6Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day06/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day06/input_test.txt")))
		{
