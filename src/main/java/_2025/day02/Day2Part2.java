...
public class Day2Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day02/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day02/input_test.txt")))
		{
