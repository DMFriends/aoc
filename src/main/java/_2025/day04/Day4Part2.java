...
public class Day4Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day04/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day04/input_test.txt")))
		{
