...
public class Day3
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day03/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day03/input_test.txt")))
		{
