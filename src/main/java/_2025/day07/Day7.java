...
public class Day7
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day07/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day07/input_test.txt")))
		{
