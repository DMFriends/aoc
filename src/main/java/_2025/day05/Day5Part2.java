...
public class Day5Part2
{
	...
	{
		try (Scanner input = new Scanner(new File("./src/main/java/_2025/day05/input.txt")))
		//try (Scanner input = new Scanner(new File("./src/main/java/_2025/day05/input_test.txt")))
		{
